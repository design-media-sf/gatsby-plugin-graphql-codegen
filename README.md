...
Only difference is the version of the graphql dependency.

Should revert projects back to the official version if/when it becomes compatible with Gatsby 5 or graphql ^16.
